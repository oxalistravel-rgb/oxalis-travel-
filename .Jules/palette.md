## 2026-08-18 - Remove maximum-scale from viewport meta tag
...
**Action:** Always ensure the viewport meta tag allows scaling by omitting `maximum-scale` or setting it to a reasonable value.
